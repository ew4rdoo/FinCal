...
import { Calendar, TrendingUp, Bell, Star, ChevronLeft, ChevronRight, Search, X, Clock, Filter, Zap, Globe, Building2, Coins, BarChart3, ExternalLink, AlertCircle, FileText, BarChart2, DollarSign, Loader2, RefreshCw } from 'lucide-react';

const allEvents = [
  { id: 1, title: 'FOMC Interest Rate Decision', date: '2026-01-29', time: '14:00', category: 'central-bank', impact: 'critical', description: 'The Federal Reserve will announce its monetary policy decision.', consensus: 'Hold at 4.25%', previous: '4.25%', followers: 45200, searchTerms: ['Federal Reserve', 'FOMC', 'interest rate', 'Fed rate decision'], relatedTickers: ['SPY', 'QQQ', 'TLT', 'GLD'] },
  { id: 2, title: 'Tesla Q4 Earnings', date: '2026-01-29', time: '17:00', category: 'earnings', impact: 'high', ticker: 'TSLA', description: 'Tesla reports Q4 2025 results.', consensus: '$0.78 EPS', previous: '$0.72 EPS', followers: 38100, searchTerms: ['Tesla', 'TSLA', 'Tesla earnings'], relatedTickers: ['RIVN', 'LCID', 'F', 'GM'] },
  { id: 3, title: 'Microsoft Q2 Earnings', date: '2026-01-29', time: '16:00', category: 'earnings', impact: 'high', ticker: 'MSFT', description: 'Microsoft reports fiscal Q2 2026 results.', consensus: '$3.12 EPS', previous: '$2.99 EPS', followers: 29400, searchTerms: ['Microsoft', 'MSFT', 'Microsoft earnings'], relatedTickers: ['GOOGL', 'AMZN', 'NVDA'] },
  { id: 4, title: 'Apple Q1 Earnings', date: '2026-01-30', time: '16:30', category: 'earnings', impact: 'high', ticker: 'AAPL', description: 'Apple reports fiscal Q1 2026 results.', consensus: '$2.35 EPS', previous: '$2.18 EPS', followers: 52300, searchTerms: ['Apple', 'AAPL', 'Apple earnings', 'iPhone'], relatedTickers: ['QCOM', 'TSM', 'AVGO'] },
  { id: 5, title: 'US Non-Farm Payrolls', date: '2026-02-07', time: '08:30', category: 'economic', impact: 'critical', description: 'January employment data release.', consensus: '+180K', previous: '+216K', followers: 41000, searchTerms: ['jobs report', 'employment', 'payrolls', 'unemployment'], relatedTickers: ['SPY', 'DIA', 'IWM'] },
  { id: 6, title: 'US CPI Inflation', date: '2026-02-12', time: '08:30', category: 'economic', impact: 'critical', description: 'January Consumer Price Index release.', consensus: '2.9% YoY', previous: '2.9% YoY', followers: 38700, searchTerms: ['inflation', 'CPI', 'consumer price'], relatedTickers: ['TIP', 'GLD'] },
  { id: 7, title: 'Bitcoin ETF Options Expiry', date: '2026-01-31', time: '16:00', category: 'crypto', impact: 'high', description: 'Monthly options expiration for spot Bitcoin ETFs.', followers: 67800, searchTerms: ['Bitcoin', 'BTC', 'Bitcoin ETF', 'crypto'], relatedTickers: ['IBIT', 'FBTC', 'GBTC'] },
  { id: 8, title: 'ETHDenver 2026', date: '2026-02-28', time: '09:00', category: 'crypto', impact: 'medium', description: 'Largest Ethereum community gathering.', location: 'Denver, CO', followers: 23400, searchTerms: ['Ethereum', 'ETH', 'ETHDenver'] },
  { id: 9, title: 'Nvidia Q4 Earnings', date: '2026-02-26', time: '16:20', category: 'earnings', impact: 'critical', ticker: 'NVDA', description: 'Most anticipated earnings - AI chip demand focus.', consensus: '$0.89 EPS', previous: '$0.81 EPS', followers: 71200, searchTerms: ['Nvidia', 'NVDA', 'Nvidia earnings', 'AI chips'], relatedTickers: ['AMD', 'INTC', 'TSM'] },
  { id: 10, title: 'Amazon Q4 Earnings', date: '2026-02-06', time: '16:00', category: 'earnings', impact: 'high', ticker: 'AMZN', description: 'Amazon reports Q4 2025 results.', consensus: '$1.85 EPS', previous: '$1.43 EPS', followers: 34500, searchTerms: ['Amazon', 'AMZN', 'Amazon earnings', 'AWS'], relatedTickers: ['MSFT', 'GOOGL', 'WMT'] },
  { id: 11, title: 'ECB Interest Rate Decision', date: '2026-02-06', time: '08:15', category: 'central-bank', impact: 'high', description: 'European Central Bank monetary policy decision.', consensus: '25bp cut expected', previous: '3.00%', followers: 18900, searchTerms: ['ECB', 'European Central Bank', 'Europe rate'], relatedTickers: ['EWG', 'FXE', 'VGK'] },
  { id: 12, title: 'Meta Q4 Earnings', date: '2026-02-05', time: '16:00', category: 'earnings', impact: 'high', ticker: 'META', description: 'Meta reports Q4 2025 results.', consensus: '$6.82 EPS', previous: '$5.33 EPS', followers: 28700, searchTerms: ['Meta', 'Facebook', 'META', 'Meta earnings'], relatedTickers: ['GOOGL', 'SNAP', 'PINS'] },
  { id: 13, title: 'Stripe IPO', date: '2026-03-15', time: '09:30', category: 'ipo', impact: 'critical', description: 'Stripe NYSE debut - largest tech IPO since 2021.', followers: 89400, searchTerms: ['Stripe', 'Stripe IPO', 'fintech IPO'], relatedTickers: ['PYPL', 'SQ', 'FIS'] },
  { id: 14, title: 'Consensus 2026', date: '2026-05-14', time: '09:00', category: 'crypto', impact: 'medium', description: 'Major crypto conference', location: 'Austin, TX', followers: 15600, searchTerms: ['crypto conference', 'Bitcoin conference'] },
  { id: 15, title: 'OPEC+ Meeting', date: '2026-02-01', time: '10:00', category: 'global', impact: 'high', description: 'Oil production quota decision', followers: 21800, searchTerms: ['OPEC', 'oil', 'oil production'], relatedTickers: ['USO', 'XLE', 'OXY'] },
  { id: 16, title: 'Alphabet Q4 Earnings', date: '2026-02-04', time: '16:00', category: 'earnings', impact: 'high', ticker: 'GOOGL', description: 'Google parent reports Q4.', followers: 31200, searchTerms: ['Google', 'Alphabet', 'GOOGL', 'Google earnings'], relatedTickers: ['META', 'MSFT'] },
  { id: 17, title: 'JPMorgan Q4 Earnings', date: '2026-01-31', time: '07:00', category: 'earnings', impact: 'high', ticker: 'JPM', description: 'Largest US bank reports.', followers: 19800, searchTerms: ['JPMorgan', 'JPM', 'bank earnings'], relatedTickers: ['BAC', 'WFC', 'GS'] },
  { id: 18, title: 'Bank of Japan Decision', date: '2026-01-30', time: '23:00', category: 'central-bank', impact: 'high', description: 'BOJ monetary policy statement', followers: 16400, searchTerms: ['Bank of Japan', 'BOJ', 'Japan rate'], relatedTickers: ['EWJ', 'DXJ'] },
];
...
// Polymarket API search function
async function searchPolymarket(searchTerms) {
  ...
  for (const term of searchTerms.slice(0, 2)) { // Limit to 2 searches
    try {
      ...
      console.log('Polymarket search error:', e);
    }
  }
...
export default function Home() {
  ...
  // Fetch Polymarket data when Predict tab is opened
  useEffect(() => {
    if (activeTab === 'predict' && selectedEvent && polymarketResults.length === 0 && !polymarketLoading) {
      ...
      searchPolymarket(selectedEvent.searchTerms || [selectedEvent.title])
        ...
        .catch(err => {
          setPolymarketError('Could not load markets');
          setPolymarketLoading(false);
        });
    }
  ...
  const openEventModal = (event) => { setSelectedEvent(event); setActiveTab('overview'); setPolymarketResults([]); };
            ...
            <div style={{ background: 'linear-gradient(135deg, rgba(239,68,68,0.08), rgba(239,68,68,0.02))', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 12, padding: 20, marginBottom: 24 }}>
              ...
              <div style={{ display: 'flex', gap: 12, overflowX: 'auto' }}>
                {criticalEvents.map(event => (
                  <div key={event.id} onClick={() => openEventModal(event)} style={{ minWidth: 200, background: '#18181b', borderRadius: 10, padding: 16, cursor: 'pointer', border: '1px solid #27272a' }}>
                    ...
                    <div style={{ fontSize: 12, color: '#71717a' }}>{new Date(event.date).toLocaleDateString('en-US', { weekday: 'short', month: 'short', day: 'numeric' })} · {event.time}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div onClick={() => setSelectedEvent(null)} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 200, padding: 20 }}>
          <div onClick={e => e.stopPropagation()} style={{ background: '#18181b', borderRadius: 16, border: '1px solid #27272a', maxWidth: 640, width: '100%', maxHeight: '90vh', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', borderBottom: '1px solid #27272a' }}>
              {[{ id: 'overview', label: 'Overview', icon: BarChart2 }, { id: 'research', label: 'Research', icon: FileText }, { id: 'predict', label: 'Predict', icon: DollarSign }].map(tab => (
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: 24 }}>
              ...
              {activeTab === 'predict' && (<>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
                  ...
                  <button onClick={refreshPolymarket} disabled={polymarketLoading} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 12px', background: '#27272a', border: 'none', borderRadius: 6, color: '#a1a1aa', fontSize: 12, cursor: 'pointer' }}>
                    <RefreshCw size={14} className={polymarketLoading ? 'animate-spin' : ''} style={{ animation: polymarketLoading ? 'spin 1s linear infinite' : 'none' }} /> Refresh
                  </button>
                </div>
                ...
                {!polymarketLoading && polymarketResults.length === 0 && (
                  <div style={{ textAlign: 'center', padding: '48px 24px', background: '#09090b', borderRadius: 12, border: '1px solid #27272a' }}>
                    ...
                    <div style={{ fontSize: 14, color: '#71717a', marginBottom: 8 }}>No active markets found for this event</div>
                    <a href={`https://polymarket.com/search?query=${encodeURIComponent(selectedEvent.searchTerms?.[0] || selectedEvent.title)}`} target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: '#6366f1', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                      Search Polymarket manually <ExternalLink size={12} />
                    </a>
                  </div>
                )}
                      ...
                      return (
                        <a key={market.id} href={`https://polymarket.com/event/${market.slug}`} target="_blank" rel="noopener noreferrer" style={{ display: 'block', background: '#09090b', border: '1px solid #27272a', borderRadius: 12, padding: 16, textDecoration: 'none', color: 'inherit' }}>
                          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 12 }}>
                            {market.image && <img src={market.image} alt="" style={{ width: 40, height: 40, borderRadius: 8, objectFit: 'cover' }} onError={(e) => e.target.style.display = 'none'} />}
                            <div style={{ flex: 1 }}>
                              <div style={{ fontSize: 14, fontWeight: 500, color: '#fafafa', lineHeight: 1.4, marginBottom: 4 }}>{market.question}</div>
                              <div style={{ fontSize: 11, color: '#71717a' }}>Vol: {formatVolume(market.volume)}</div>
                            </div>
                ...
                <div style={{ marginTop: 20, paddingTop: 20, borderTop: '1px solid #27272a' }}>
                  <div style={{ fontSize: 12, color: '#71717a', marginBottom: 12 }}>OTHER PLATFORMS</div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    <a href={`https://kalshi.com/search?query=${encodeURIComponent(selectedEvent.searchTerms?.[0] || selectedEvent.title)}`} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 12, padding: 12, background: '#09090b', borderRadius: 8, border: '1px solid #27272a', textDecoration: 'none', color: 'inherit' }}>
                      <span style={{ fontSize: 16 }}>🎯</span>
                      <div style={{ flex: 1 }}><div style={{ fontSize: 13, fontWeight: 500, color: '#fafafa' }}>Kalshi</div><div style={{ fontSize: 11, color: '#71717a' }}>CFTC-regulated markets</div></div>
                      <ExternalLink size={14} color="#6366f1" />
                    </a>
                    <a href="https://www.predictit.org/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 12, padding: 12, background: '#09090b', borderRadius: 8, border: '1px solid #27272a', textDecoration: 'none', color: 'inherit' }}>
                      <span style={{ fontSize: 16 }}>📊</span>
                      <div style={{ flex: 1 }}><div style={{ fontSize: 13, fontWeight: 500, color: '#fafafa' }}>PredictIt</div><div style={{ fontSize: 11, color: '#71717a' }}>Political markets</div></div>
                      <ExternalLink size={14} color="#6366f1" />
                    </a>
                  </div>
                </div>

                <div style={{ marginTop: 16, padding: 14, background: 'rgba(99,102,241,0.08)', borderRadius: 10, border: '1px solid rgba(99,102,241,0.2)' }}>
                  <div style={{ fontSize: 12, color: '#a5b4fc', marginBottom: 4 }}>💡 How prediction markets work</div>
                  <div style={{ fontSize: 12, color: '#71717a' }}>Prices reflect crowd probability. Buy "Yes" at 60¢ if you think there's more than 60% chance. Correct predictions pay $1.</div>
                </div>
              </>)}
            </div>
          </div>
